...
export const Hero: React.FC<HeroProps> = ({ onOpenModal }) => {
  return (
    <section id="home" className="relative min-h-screen pt-28 pb-16 lg:pt-36 lg:pb-24 flex items-center overflow-hidden bg-[#FAF9F5]">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-100/60 via-[#FAF9F5] to-[#FAF9F5] pointer-events-none" />
      <div className="absolute top-1/4 right-10 w-96 h-96 bg-purple-200/50 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-40" xmlns="http://www.w3.org/2000/svg">
        <path d="M -100 200 Q 400 50 900 350 T 1900 200" fill="none" stroke="#A78BFA" strokeWidth="1.5" strokeDasharray="8 8" className="animate-flight-path" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* Small Label Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 border border-purple-200 shadow-[0_4px_16px_rgba(139,92,246,0.12)] backdrop-blur-md">
              <Sparkles className="w-3.5 h-3.5 text-purple-600 animate-spin" style={{ animationDuration: '8s' }} />
              <span className="text-[11px] sm:text-xs font-bold tracking-widest text-purple-900 uppercase">
                TRAVEL • VISA • TOURS
              </span>
            </div>
            ...
            <div className="space-y-1 sm:space-y-2">
              ...
              <h2 className="text-3xl sm:text-4xl xl:text-5xl font-script bg-gradient-to-r from-purple-700 via-pink-600 to-amber-600 bg-clip-text text-transparent font-normal tracking-wide transform -rotate-1 py-1">
                Journeys Made Possible!
              </h2>
            </div>

            {/* Supporting Badge Banner */}
            <div className="inline-block bg-purple-50/90 border-l-4 border-purple-600 border-y border-r border-purple-200/70 px-4 py-2 rounded-r-xl shadow-sm">
              <p className="text-xs sm:text-sm font-semibold text-slate-700">
                We make your <span className="text-purple-700 font-bold uppercase tracking-wider">VISA PROCESS SIMPLE & STRESS-FREE</span>
              </p>
            </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
              <button
                onClick={() => onOpenModal()}
                className="px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 via-pink-500 to-amber-500 hover:from-purple-700 hover:to-pink-600 text-white font-extrabold text-sm sm:text-base shadow-[0_8px_25px_rgba(124,58,237,0.28)] hover:shadow-[0_10px_30px_rgba(124,58,237,0.38)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 group"
              >
              ...
              <a
                href="#services"
                className="px-7 py-4 rounded-full bg-white hover:bg-purple-50 border border-purple-200 text-slate-800 font-bold text-sm sm:text-base transition-all flex items-center justify-center gap-2 hover:border-purple-400 shadow-sm"
              >
            ...
            <div className="pt-6 border-t border-slate-200/80 grid grid-cols-3 gap-2 text-left">
              <div className="flex items-center gap-2">
                <Globe2 className="w-5 h-5 text-purple-600 flex-shrink-0" />
                <div>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md xl:max-w-lg aspect-square">
              ...
              <div className="absolute inset-0 rounded-full border border-purple-200/60 animate-spin" style={{ animationDuration: '30s' }} />
              <div className="absolute inset-4 rounded-full border border-dashed border-pink-300/60 animate-spin" style={{ animationDuration: '45s', animationDirection: 'reverse' }} />

              {/* Central Premium Travel Artwork Composition */}
              <div className="relative w-full h-full rounded-3xl overflow-hidden bg-white p-3 border border-purple-200 shadow-[0_20px_50px_rgba(139,92,246,0.15)] group">
                ...
                <div className="absolute -top-3 -right-3 sm:-top-5 sm:-right-5 bg-white border-2 border-purple-200 p-3 sm:p-4 rounded-2xl shadow-xl animate-float-slow flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 flex items-center justify-center text-white font-bold shadow-md">
                    <Plane className="w-6 h-6 transform rotate-45" />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-slate-900">99% Approval</div>
                    <div className="text-[10px] text-purple-700 font-semibold">Fast Embassy Filing</div>
                  </div>
                </div>

                {/* Floating Landmark Badge */}
                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-purple-100 shadow-xl space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-purple-700 uppercase tracking-wider flex items-center gap-1.5">
                      <Award className="w-4 h-4 text-purple-600" /> Global Visa Assistance
                    </span>
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500 pt-1 border-t border-slate-100">
                    ...
                    <span className="font-mono text-purple-800 font-bold">{DISPLAY_PHONE}</span>
                  </div>
                </div>
