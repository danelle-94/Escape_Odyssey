...
export const StatsStrip: React.FC = () => {
  ...
  return (
    <section className="relative z-20 -mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 bg-white/95 backdrop-blur-xl border border-blue-100 rounded-2xl p-6 sm:p-8 shadow-[0_15px_40px_rgba(1,93,165,0.08)]">
        {stats.map((stat, idx) => {
            ...
            >
              ...
              <div className="space-y-0.5">
                <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-cinzel tracking-tight">
                  <span className="text-[#015da5]">{stat.number}</span>
                </div>
