        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="space-y-1 sm:space-y-2">
              ...
              <h2 className="text-3xl sm:text-4xl xl:text-5xl font-script text-[#0074B5] font-normal tracking-wide transform -rotate-1 py-1">
                Journeys Made Possible!
              </h2>
            </div>

            {/* Supporting Badge Banner */}
            <div className="inline-block bg-blue-50/90 border-l-4 border-[#0074B5] border-y border-r border-blue-200/70 px-4 py-2 rounded-r-xl shadow-sm">
              <p className="text-xs sm:text-sm font-semibold text-slate-700">
                We make your <span className="text-[#0074B5] font-bold uppercase tracking-wider">VISA PROCESS SIMPLE & STRESS-FREE</span>
              </p>
            </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
              <button
                onClick={() => onOpenModal()}
                className="px-8 py-4 rounded-full bg-[#0074B5] hover:bg-[#005C91] text-white font-extrabold text-sm sm:text-base shadow-[0_8px_25px_rgba(0,116,181,0.3)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 group"
              >
              ...
              <a
                href="#services"
                className="px-7 py-4 rounded-full bg-white hover:bg-blue-50 border border-blue-200 text-slate-800 font-bold text-sm sm:text-base transition-all flex items-center justify-center gap-2 hover:border-[#0074B5] shadow-sm"
              >
                <Compass className="w-4 h-4 text-[#0074B5]" />
            ...
            <div className="pt-6 border-t border-slate-200/80 grid grid-cols-3 gap-2 text-left">
              <div className="flex items-center gap-2">
                <Globe2 className="w-5 h-5 text-[#0074B5] flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-5 h-5 text-[#0074B5] flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center gap-2">
                <Clock className="w-5 h-5 text-[#0074B5] flex-shrink-0" />
                <div>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md xl:max-w-lg aspect-square">
              ...
              <div className="relative w-full h-full rounded-3xl overflow-hidden bg-white p-3 border border-blue-200 shadow-[0_20px_50px_rgba(0,116,181,0.15)] group">
                ...
                <div className="absolute -top-3 -right-3 sm:-top-5 sm:-right-5 bg-white border-2 border-blue-200 p-3 sm:p-4 rounded-2xl shadow-xl animate-float-slow flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#0074B5] flex items-center justify-center text-white font-bold shadow-md">
