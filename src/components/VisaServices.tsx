            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="w-16 h-16 rounded-full bg-blue-50 flex items-center justify-center shadow-md border-2 border-blue-200 group-hover:scale-110 group-hover:bg-blue-100 transition-transform">
